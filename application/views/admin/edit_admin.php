                                        ...
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <select data-parsley-required data-parsley-required-message="Please Select Role." class="form-control" id="role_id" name="role_id">
                                                    ...
                                                    <option <?php if($admin_data['role_id']==$list['role_id']){ echo 'selected';}?>  value="<?php echo $list['role_id'];?>" ><?php echo $list['name'];?></option>
                                                    <?php }}?> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" maxlength="50" oninput="this.value = this.value.replace(/[^A-Za-z0-9-'()& ]/g,'');" name="fullname" id="fullname" data-parsley-maxlength="50"  data-parsley-pattern="^[a-z A-Z 0-9 ]+$"  value="<?php if(isset($admin_data['fullname'])) echo $admin_data['fullname']; ?>" placeholder="Full Name" data-parsley-pattern-message="please enter vaild full name."  data-parsley-required data-parsley-required-message="Please enter full name.">
                                                <?php echo form_error('fullname'); ?>
                                            </div>

                                            <div class="form-group">
                                                <label for="username">Username *</label>
                                                <input type="text"  class="form-control" id="username" name="username" data-parsley-required  onkeyup="this.value = this.value.replace(/[^A-Za-z0-9-_.']/g,'');"  placeholder="Username" value="<?php if(isset($admin_data['username'])) echo $admin_data['username']; ?>" data-parsley-minlength="6" data-parsley-maxlength="12" data-parsley-required data-parsley-required-message="Please enter username." data-parsley-minlength-message="Username must be at least 6 characters long." data-parsley-maxlength-message="Username must be at most 12 characters long.">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" maxlength="50" data-parsley-maxlength="50"  name="email" id="email" placeholder="Email" value="<?php if(isset($admin_data['email'])) echo $admin_data['email']; ?>" data-parsley-required data-parsley-required-message="Please enter valid email." data-parsley-type="email" data-parsley-type-message="Please enter valid email." >
                                            ...
                                            <div class="box-footer">
                                                <div class="form-group">
                                                    <div class="col-sm-offset-3 col-sm-9">
                                                        <button type="submit" name="form_submit1" value="form_submit1" class="btn btn-primary">Update</button>
                        ...
                        <div class="box-body">
                            <form class="form-horizontal">
                                            ...
                                            <div class="controls">
                                                <div data-provides="fileupload" class="fileupload fileupload-new">
                                                    <div class="fileupload-new thumbnail" style="width: auto;max-width: 150px;">
                                                        ...
                                                        <?php }else{ ?>
                                                             <img alt="No Image" src="<?php echo base_url().'assets/images/placeholder_image.jpeg';?>" style="width: auto;">
                                                        <?php } ?>
                                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                         <button type="button" id="img_upload_button" class="btn btn-info upload_profile_pic">Save</button>
                                        </div>
                                    </div>
                                    <div class="form-group" >
                                        <div class="col-sm-8">
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="panel-body">
                                ...
                                <?php } ?>
                                    <form method="POST" action="<?php echo current_url(); ?>" id="form2" role="form" data-parsley-validate>
                                    <div class="box-body">
                                        <div class="form-group">
                                    ...
                                    <div class="box-footer text-center">
                                        <button type="submit" name="form_submit2" id="submit2" value="submit2" class="btn btn-primary" >Update</button>
                                        <a href="admin/subadmin/list" class="btn btn-default">Back</a> 
                                    </div> 
                                </form>
                            </div>
